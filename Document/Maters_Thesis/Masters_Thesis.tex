...
前の節でニューラルネットワークによる学習で温度測定器を作ることで，イジング模型の相転移点を相転移の情報なして検出できることがわかった．2019年にはこの研究結果からさらに，ニューラルネットワークが何を学習しているのかという学習の中身について研究した論文が投稿された．
\subsection{臨界温度予測}
...
\chapter*{まとめ}
本論文で最初に相転移現象とイジング模型の基礎，それから機械学習の概要を説明した後に，機械学習を応用したイジング模型の相転移検出に関する研究について，研究の内容と実験結果を説明した．\par
この研究を通して，近年話題になっているAI，機械学習という分野が物理学の研究にどう生かされているかということを感じることができた．本論文で紹介した，研究はイジング模型の相転移検出ということで，大学の物理学の授業で習うのみを扱っている．
ここ最近の研究では，
