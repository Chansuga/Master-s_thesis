...
我々，人間には視覚情報からパターンを認識する高い能力が備わっている．その仕組みはいまだにわかっていないことが多いが，ニューロンのネットワークがもつ構造に理由があると考えられている．\par
1958年にハーバード大学のヒューベルとウィーゼルは，猫の視覚野に特定の傾きをもつ線分を見せたときにだけ反応する細胞があることを発見した．さらにそのような細胞は2種類に大別できることを明らかにし，それらは単純型細胞と複雑型細胞とよばれる．これらの違いを明らかにするために，受容野の概念を導入しよう．受容野とはニューロンを発火させるような入力を生じさせる領域のことをいう．\par
図\ref{}は，網膜(左の四角い領域)から視覚刺激を受け取ったときに，縦に並んだ4つのニューロンがどう変化するかを示した概念図で(a)が単純型細胞，(b)が複雑型細胞を表している．まず(a)に注目しよう．灰色で塗りつぶされた部分が受容野であり，上から3つ目のニューロンが受容野と対応している．(a)の上の図では
