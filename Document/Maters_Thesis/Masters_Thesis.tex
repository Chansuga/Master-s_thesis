...
前の節でニューラルネットワークによる学習で温度測定器を作ることで，イジング模型の相転移点を相転移の情報なして検出できることがわかった．2019年にはこの研究結果からさらに，ニューラルネットワークが何を学習しているのかという学習の中身について研究した論文が投稿された．\cite{10.1093/ptep/ptz082}
\subsection{臨界温度予測}
